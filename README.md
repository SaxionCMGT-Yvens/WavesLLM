...
This repository has been archived, and its development will continue on the [original repository](https://github.com/YvensFaos/GameOffWaves25).
Any information and code remaining in this repository should be seen as outdated.
...
Welcome to Waves - Grid Framework. Waves is a simple grid-based system for Unity that can be used to make turn-based tactics games, such as Final Fantasy Tactics (PSOne), Fire Emblem (SNES, GBA), and Advanced Wars (GBA).
...
- **Attack Range**: Allow the actor to attack in their valid range
